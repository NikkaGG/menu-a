  ...
  return <UiTableRow>
    ...
    <TableCell>
      <div className="flex min-w-max flex-col items-start gap-2 sm:flex-row">
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild><Button type="button" variant="destructive" className="min-h-11" disabled={deleting || downloading} aria-label={`Удалить стол «${table.number}»`}><Trash2 data-icon="inline-start" />Удалить</Button></AlertDialogTrigger>
          <AlertDialogContent>
